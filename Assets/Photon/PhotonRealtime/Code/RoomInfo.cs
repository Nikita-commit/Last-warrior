...
namespace Photon.Realtime
{
    ...
    public class RoomInfo
    {
        ...
        /// </summary>
        public int playerntCount { get; private set; }
        ...
        {
            return string.Format("Room: '{0}' {1},{2} {4}/{3} players.", this.name, this.isVisible ? "visible" : "hidden", this.isOpen ? "open" : "closed", this.maxPlayers, this.playerntCount);
        }
        ...
        {
            return string.Format("Room: '{0}' {1},{2} {4}/{3} players.\ncustomProps: {5}", this.name, this.isVisible ? "visible" : "hidden", this.isOpen ? "open" : "closed", this.maxPlayers, this.playerntCount, this.customProperties.ToStringFull());
        }
        ...
        protected internal virtual void InternalCacheProperties(Hashtable propertiesToCache)
        {
            ...
            {
                this.playerntCount = (int)((byte)propertiesToCache[GamePropertyKey.PlayerCount]);
            }
